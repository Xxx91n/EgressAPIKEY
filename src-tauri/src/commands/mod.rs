...
/// Single Resin error -> IpcError mapping lives in resin-core
/// (crates/resin-core/src/ipc_error.rs, architecture-recovery ticket 06).
/// The former shell-side duplicate was deleted; call sites below keep using
/// the bare name via this re-export.
