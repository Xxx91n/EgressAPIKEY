...
export const CMD_TO_HTTP: Record<string, HttpRoute> = {
  ...
  orchestration_approve: { method: "POST", path: "/api/v1/shell/orchestration/approve", bodyKeys: { platformName: "platform_name" } },
  orchestration_dismiss: { method: "POST", path: "/api/v1/shell/orchestration/dismiss", bodyKeys: { platformName: "platform_name" } },
