  ...
  await i18next.use(initReactI18next).init({
    resources: {
      en: { translation: {
        ...
        "topConverge.compact.NeverApplied": "○ never",
        "topConverge.compact.Drifted": "↯ drifted",
        "topConverge.compact.Unknown": "? unknown",
        "topConverge.tooltip.expectedRev": "Desired rev: {{rev}}",
        "topConverge.tooltip.appliedRev": "Applied rev: {{rev}}",
        "topConverge.tooltip.appliedAt": "Last applied at {{time}}",
        "topConverge.tooltip.error": "Reason: {{reason}}",
        "topConverge.tooltip.neverApplied": "Apply has never run on this configuration",
        "topConverge.tooltip.clickHint": "Click to open Effective Config",
        "topConverge.sideRail.PendingApply": "Apply pending",
        "topConverge.sideRail.ApplyFailed": "Apply failed",
        "topConverge.sideRail.NeverApplied": "Never applied",
        "topConverge.sideRail.Drifted": "Live state drifted",
        "topConverge.sideRail.Unknown": "Convergence unknown (Resin down)",
        ...
        "subscription.phaseNever": "Never established",
        "subscription.phaseImporting": "Importing",
        "subscription.phaseEstablishing": "Establishing",
        "subscription.phaseConverged": "Established",
        "subscription.phaseFailed": "Failed",
        "subscription.phaseNeedsApproval": "Needs approval",
        ...
        "subscription.retry": "Retry {{name}}",
        "subscription.retryLabel": "Retry",
        "subscription.retryOk": "Retry requested for {{name}}",
        "subscription.retryUrlMissing": "Cannot retry {{name}}: Resin no longer reports its source URL",
        ...
        "settings.exportAuditLog": "Export audit log",
        "settings.exportAuditLogDone": "Exported {{rows}} audit entries ({{bytes}} bytes)",
        "settings.exportAuditLogError": "Audit export failed",
