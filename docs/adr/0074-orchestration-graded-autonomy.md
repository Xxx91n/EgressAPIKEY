...
- **See also**: [ADR-0080](0080-signal-plane-probe-verdicts.md) — typed signal-plane verdicts; supersedes this ADR's majority-rule aggregation segment (evidence typing only — state machine, phases and parameters unchanged)
